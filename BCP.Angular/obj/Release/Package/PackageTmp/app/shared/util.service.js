(function () {
    ...
    function utilService(globalService) {
        ...
        servicio.obtenerLogActualizacion = obtenerLogActualizacion;
        ...
        function obtenerLogActualizacion() {

            const fechaActual = new Date();

            return `${fechaActual.getFullYear()}-${(fechaActual.getMonth() + 1).toString().padStart(2, '0')}-${fechaActual.getDate().toString().padStart(2, '0')} ${fechaActual.getHours().toString().padStart(2, '0')}:${fechaActual.getMinutes().toString().padStart(2, '0')}:${fechaActual.getSeconds().toString().padStart(2, '0')} | ${globalService.usuarioLogueado.cCodUsuario}`;
